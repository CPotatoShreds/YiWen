...
import { api } from "../../api";
import { ChevronRightIcon, EyeIcon, TrashIcon, XIcon } from "../../components/icons";
...
export default function AdminBattles() {
  const [items, setItems] = useState<AdminBattle[]>([]); const [selected, setSelected] = useState<AdminBattle | null>(null); const [err, setErr] = useState(""); const navigate = useNavigate();
